...
def load_pretrain(
        ...
        pretrain_directory: str = 'src/CellPLM/ckpt/'):
    config_path = os.path.join('src/CellPLM/ckpt/', f'{pretrain_prefix}.config.json')
    ckpt_path = os.path.join('src/CellPLM/ckpt/', f'{pretrain_prefix}.best.ckpt')
